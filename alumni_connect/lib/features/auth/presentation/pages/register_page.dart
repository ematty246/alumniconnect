...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (_passwordScore < 4) {
      context.read<ToastProvider>().showError('Password is too weak. Please create a stronger password.');
      return;
    }
    ...
    try {
      ...
      if (result['success'] == true) {
        context.read<ToastProvider>().showSuccess(result['message'] ?? 'Registration successful');
        ...
        context.read<ToastProvider>().showError(result['message'] ?? 'Registration failed');
      }
    } catch (e) {
      context.read<ToastProvider>().showError('Registration failed. Please try again.');
    } finally {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  if (_selectedRole == 'FACULTY' || _selectedRole == 'STUDENT') ...[
                    DropdownButtonFormField<String>(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: (_isLoading || _passwordScore < 4) ? null : _handleRegister,
