            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 40),
                  if (user != null) _buildQuickActions(context, user.role),
    ...
    final features = [
      {
        ...
        'title': 'Connect',
        'description':
            'Build meaningful connections with alumni, current students, and faculty members from your institution.',
      ...
      },
      {
        ...
        'title': 'Chat',
        'description':
            'Engage in real-time conversations, share experiences, and collaborate on projects with your network.',
      ...
      },
      {
        ...
        'title': 'Discover',
        'description':
            'Find and connect with people based on interests, departments, graduation years, and professional backgrounds.',
      ...
      case 'STUDENT':
        return [
          ...
          },
          {
            ...
            'title': 'Chat',
            'description':
                'Engage in real-time conversations, get career advice, and collaborate with your network.',
            'gradient': AppTheme.accentGradient,
          },
          {
            'icon': Icons.search,
            'title': 'Find People',
            'description':
                'Discover alumni in your field, find study groups, and connect with potential mentors.',
            'gradient': AppTheme.successGradient,
          },
          {
            'icon': Icons.person,
            ...
            'description':
                'Showcase your skills, projects, and academic achievements to attract connections.',
        ...
        return [
          {
            ...
            'title': 'Profile Management',
            'description':
                'Keep your professional profile updated and showcase your career journey to inspire students.',
            'gradient': AppTheme.successGradient,
          },
          {
            'icon': Icons.chat,
            'title': 'Chat',
            'description':
                'Mentor students, share career insights, and stay connected with your network.',
            'gradient': AppTheme.accentGradient,
          },
          {
            'icon': Icons.people,
            'title': 'Connect',
            'description':
                'Maintain relationships with fellow alumni and connect with current students seeking guidance.',
            'gradient': AppTheme.primaryGradient,
          },
        ];
      case 'FACULTY':
        return [
          {
            ...
            'title': 'Connect',
            'description':
                'Build connections with students, alumni, and fellow faculty members across departments.',
            'gradient': AppTheme.primaryGradient,
          },
          {
            'icon': Icons.chat,
            'title': 'Chat',
            'description':
                'Communicate with students, collaborate with colleagues, and provide academic guidance.',
            'gradient': AppTheme.accentGradient,
          },
          {
            'icon': Icons.search,
            'title': 'Find People',
            'description':
                'Discover students in your courses, connect with alumni, and network with other faculty.',
            'gradient': AppTheme.successGradient,
          },
          {
            'icon': Icons.person,
            'title': 'Profile Management',
            'description':
                'Maintain your academic profile, showcase research, and highlight your expertise.',
            'gradient': const LinearGradient(
                colors: [AppTheme.warningColor, Color(0xFFD97706)]),
          },
        ];
