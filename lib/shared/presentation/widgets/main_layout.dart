...
class MainLayout extends StatelessWidget {
    ...
    return Consumer2<AuthProvider, NotificationProvider>(
      builder: (context, authProvider, notificationProvider, _) {
        return Scaffold(
          ...
          drawer: _buildAppDrawer(context, authProvider, notificationProvider),
          body: Container(
  ...
  Drawer _buildAppDrawer(BuildContext context, AuthProvider authProvider,
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          _buildDrawerItem(context, Icons.video_call, 'Webinar',
              () => context.go('/webinar')),
          if (user != null) ...[
